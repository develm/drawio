 ...
 */
package com.sql.er.imports.canvas;
...
import com.sql.er.imports.shape.mxActorShape;
import com.sql.er.imports.shape.mxArrowShape;
import com.sql.er.imports.shape.mxCloudShape;
import com.sql.er.imports.shape.mxConnectorShape;
import com.sql.er.imports.shape.mxCurveShape;
import com.sql.er.imports.shape.mxCylinderShape;
import com.sql.er.imports.shape.mxDefaultTextShape;
import com.sql.er.imports.shape.mxDoubleEllipseShape;
import com.sql.er.imports.shape.mxDoubleRectangleShape;
import com.sql.er.imports.shape.mxEllipseShape;
import com.sql.er.imports.shape.mxHexagonShape;
import com.sql.er.imports.shape.mxHtmlTextShape;
import com.sql.er.imports.shape.mxIShape;
import com.sql.er.imports.shape.mxITextShape;
import com.sql.er.imports.shape.mxImageShape;
import com.sql.er.imports.shape.mxLabelShape;
import com.sql.er.imports.shape.mxLineShape;
import com.sql.er.imports.shape.mxRectangleShape;
import com.sql.er.imports.shape.mxRhombusShape;
import com.sql.er.imports.shape.mxStencilRegistry;
import com.sql.er.imports.shape.mxSwimlaneShape;
import com.sql.er.imports.shape.mxTriangleShape;
import com.sql.er.imports.swing.util.mxSwingConstants;
