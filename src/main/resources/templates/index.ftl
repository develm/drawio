...
<head>
	...
	<script type="text/javascript">
		...
		if (urlParams['dev'] == '1')
		{
			...
			var mxDevUrl = document.location.protocol + '//localhost:8085/';

			// Used to request draw.io sources in dev mode
			var drawDevUrl = document.location.protocol + '//localhost:8085/';
			...
			mxscript(mxDevUrl + 'js/PreConfig.js');
			mxscript(mxDevUrl + 'js/diagramly/Init.js');
			mxscript(mxDevUrl + 'grapheditor/Init.js');
			mxscript(mxDevUrl + 'mxgraph/mxClient.js');
			...
			mxscript(mxDevUrl + 'js/PostConfig.js');
		}
		else
		{
			(function()
